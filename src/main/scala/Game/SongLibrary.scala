...
object SongLibrary:
  def loadSongs(): List[Song] =
    List(
      ...
      Song("In Boxes", 0, Album("Running with the Wolves (EP)"), Author("AURORA"), "blRQ8GUcNJ0"),
      Song("Little Boy In The Grass", 0, Album("Running with the Wolves (EP)"), Author("AURORA"), "2MTsfnntwWc"),

      // The Gods We Can Touch
      Song("The Forbidden Fruits of Eden", 0, Album("The Gods We Can Touch"), Author("AURORA"), "wItPEYN5aJw"),
      ...
      Song("A Temporary High", 0, Album("The Gods We Can Touch"), Author("AURORA"), "7_4JqVAK5WE"),
      Song("A Dangerous Thing", 0, Album("The Gods We Can Touch"), Author("AURORA"), "6KmWlzUz_54"),
      Song("Artemis", 0, Album("The Gods We Can Touch"), Author("AURORA"), "qpx1wwlQf3U"),
      Song("Blood In the Wine", 0, Album("The Gods We Can Touch"), Author("AURORA"), "sKSupqVcVJw"),
      Song("This Could Be a Dream", 0, Album("The Gods We Can Touch"), Author("AURORA"), "DbiB1AtCA9k"),
      Song("A Little Place Called the Moon", 0, Album("The Gods We Can Touch"), Author("AURORA"), "QdLNfkFWF0g"),

      // Infection Of A Different Kind – Step 1
      Song("Queendom", 0, Album("Infection Of A Different Kind – Step 1"), Author("AURORA"), "-PIC0wb8jgY"),
      ...
      Song("It Happened Quiet", 0, Album("Infection Of A Different Kind – Step 1"), Author("AURORA"), "2wd7hOSPPP0"),
      Song("Churchyard", 0, Album("Infection Of A Different Kind – Step 1"), Author("AURORA"), "KOhjQvUI3Qo"),
      Song("Soft Universe", 0, Album("Infection Of A Different Kind – Step 1"), Author("AURORA"), "daHIgxDSLMY"),
      Song("Infections Of A Different Kind", 0, Album("Infection Of A Different Kind – Step 1"), Author("AURORA"), "7EmdiaUX-wI"),

      // A Different Kind Of Human – Step 2
      Song("The River", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "pz5FzFL2L7w"),
      ...
      Song("Hunger", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "TgAjyR3_2yM"),
      Song("Soulless Creatures", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "EiWUBdyDk70"),
      Song("In Bottles", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "1okNR0Dzyv8"),
      Song("A Different Kind Of Human", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "WuPh0Ozd4EE"),
      Song("Apple Tree", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "fgjId8R5RL8"),
      Song("The Seed", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "JJTjc7iRNY8"),
      Song("Mothership", 0, Album("A Different Kind Of Human – Step 2"), Author("AURORA"), "IP1Qhq8kQBY"),

      // What Happened To The Heart?
      Song("Echo Of My Shadow", 0, Album("What Happended To The Heart?"), Author("AURORA"), "kkPYHeSU_y4"),
      ...
      Song("The Conflict Of The Mind", 0, Album("What Happended To The Heart?"), Author("AURORA"), "XO2tAfUe2HU"),
      Song("Some Type Of Skin", 0, Album("What Happended To The Heart?"), Author("AURORA"), "b1pMORnf0Hs"),
      Song("The Essence", 0, Album("What Happended To The Heart?"), Author("AURORA"), "iwthrbcxLFs"),
      ...
      Song("My Body Is Not Mine", 0, Album("What Happended To The Heart?"), Author("AURORA"), "9W9B5-J0ZKI"),
